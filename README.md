...
- **Termin vereinbart → direkt terminieren**: Wird ein Anruf mit dem Ergebnis **„Termin vereinbart"** protokolliert, öffnet sich sofort eine Maske zum Erfassen von **Datum + Uhrzeit**; der Termin landet automatisch als **besetzter** Kalendereintrag (sofern CalDAV aktiv ist)
